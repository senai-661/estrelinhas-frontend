            ...
            <div style={{ width: "100%", maxWidth: "900px", margin: "0 auto" }}>
                ...
                <div style={{ display: "flex", gap: "24px", flexWrap: "wrap" }}>
                    ...
                    <div style={{ width: "256px", flexShrink: 0, backgroundColor: "#ffffff", borderRadius: "16px", border: "1px solid #f0f0f0", padding: "24px", display: "flex", flexDirection: "column", alignItems: "center", gap: "16px" }}>
                        <div style={{ width: "80px", height: "80px", borderRadius: "50%", backgroundColor: "#ff7300", display: "flex", alignItems: "center", justifyContent: "center", color: "#ffffff", fontSize: "1.2rem", fontWeight: "bold" }}>
                            {matricula.cod_matricula}
                        </div>

                        <div style={{ textAlign: "center" }}>
                            <h2 style={{ fontSize: "1rem", fontWeight: "bold", color: "#000000", margin: 0 }}>{matricula.cod_matricula}</h2>
                            <p style={{ fontSize: "0.85rem", color: "#666", margin: "4px 0 0 0" }}>{matricula.nome} {matricula.sobrenome}</p>
                        </div>

                        <span style={{ display: "inline-flex", alignItems: "center", gap: "6px", padding: "4px 12px", borderRadius: "999px", fontSize: "0.75rem", fontWeight: "600", backgroundColor: matricula.status_matricula === "ATIVA" ? "#f0fdf4" : "#fef2f2", color: matricula.status_matricula === "ATIVA" ? "#15803d" : "#b91c1c" }}>
                            <span style={{ width: "6px", height: "6px", borderRadius: "50%", backgroundColor: matricula.status_matricula === "ATIVA" ? "#22c55e" : "#ef4444" }} />
                        ...
                        <div style={{ width: "100%", display: "flex", flexDirection: "column", gap: "8px" }}>
                            <button
                                onClick={() => navigate(`/atualizar/matricula/${matricula.id_matricula}`)}
                    ...
                    <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: "16px", minWidth: "280px" }}>
                        ...
                        <div style={{ backgroundColor: "#ffffff", borderRadius: "16px", border: "1px solid #f0f0f0", padding: "24px" }}>
                            ...
                            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
                                <Campo label="Cód. Matrícula" valor={matricula.cod_matricula ?? "—"} icone="pi-hashtag" />
                                <Campo label="Status" valor={matricula.status_matricula ?? "—"} icone="pi-info-circle" />
                                <Campo label="Cód. Aluno" valor={matricula.cod_aluno ?? "—"} icone="pi-user" />
                                <Campo label="Cód. Plano" valor={matricula.cod_plano ?? "—"} icone="pi-book" />
                            </div>
                        </div>
                        ...
                        <div style={{ backgroundColor: "#ffffff", borderRadius: "16px", border: "1px solid #f0f0f0", padding: "24px" }}>
                            ...
                            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
                                ...
                                <Campo label="Valor Final" valor={formatarValor(Number(matricula.valor_final))} icone="pi-dollar" />
                            </div>
                        </div>
