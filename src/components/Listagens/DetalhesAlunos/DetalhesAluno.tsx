            ...
            <div style={{ width: "100%", maxWidth: "900px", margin: "0 auto" }}>
                ...
                <div style={{ display: "flex", gap: "24px", flexWrap: "wrap" }}>
                    ...
                    <div style={{ width: "256px", flexShrink: 0, backgroundColor: "#ffffff", borderRadius: "16px", border: "1px solid #f0f0f0", padding: "24px", display: "flex", flexDirection: "column", alignItems: "center", gap: "16px" }}>
                        ...
                        <span style={{ display: "inline-flex", alignItems: "center", gap: "6px", padding: "4px 12px", borderRadius: "999px", fontSize: "0.75rem", fontWeight: "600", backgroundColor: aluno.status_aluno === "ATIVO" ? "#f0fdf4" : "#fef2f2", color: aluno.status_aluno === "ATIVO" ? "#15803d" : "#b91c1c" }}>
                            <span style={{ width: "6px", height: "6px", borderRadius: "50%", backgroundColor: aluno.status_aluno=== "ATIVO" ? "#22c55e" : "#ef4444" }} />
                            {aluno.status_aluno === "ATIVO" ? "Ativo" : "Inativo"}
                        </span>
                    ...
                    <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: "16px", minWidth: "280px" }}>
                        ...
                        <div style={{ backgroundColor: "#ffffff", borderRadius: "16px", border: "1px solid #f0f0f0", padding: "24px" }}>
                            ...
                            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
                                ...
                                <Campo label="Data de Nascimento" valor={formatarData(aluno.data_nascimento)} icone="pi-calendar" />
                            </div>
                        </div>
