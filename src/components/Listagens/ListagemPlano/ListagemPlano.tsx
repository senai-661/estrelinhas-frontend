    ...
    useEffect(() => {
        const buscarPlanos = async () => {
            try {
                ...
                console.log('Planos recebidos:', listaDePlanos);
            ...
            <div className="bg-gradient-to-r from-orange-500 via-orange-600 to-orange-700 px-8 py-6 shadow-xl relative overflow-hidden">
                ...
                <div className="relative flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold text-white m-0">Planos</h1>
                            <p className="text-orange-100 text-sm mt-1">Gerencie os planos de assinatura</p>
                        </div>
                    </div>
            ...
            <div className="flex-1 overflow-auto px-8 py-6">
                <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                    <div className="px-6 py-4 bg-gradient-to-r from-gray-50 to-white border-b border-gray-200">
                        <h2 className="text-lg font-semibold text-gray-800">Lista de Planos</h2>
                        <p className="text-sm text-gray-600 mt-1">Total: {planos.length} planos disponíveis</p>
                    </div>
                    <table className="w-full">
                        <thead>
                            <tr className="bg-gradient-to-r from-gray-800 to-gray-900 text-white">
                                ...
                                <th className="px-6 py-4 text-left font-semibold text-sm uppercase tracking-wider">Tipo</th>
                                <th className="px-6 py-4 text-left font-semibold text-sm uppercase tracking-wider">Duração</th>
                                <th className="px-6 py-4 text-left font-semibold text-sm uppercase tracking-wider">Valor</th>
                            ...
                            {planos && planos.length > 0 ? (
                                planos.map((plano, index) => (
                                    <tr className={`border-b border-gray-100 transition-all duration-200 ${
                                        ...
                                        <td className="px-6 py-4 text-gray-900 font-medium">{plano.tipo_plano}</td>
                                        <td className="px-6 py-4 text-gray-600">{plano.duracao_dias} dias</td>
                                        <td className="px-6 py-4">
