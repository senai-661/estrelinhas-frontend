...
function DetalhesAluno({ id_aluno }: DetalhesAlunoProps): JSX.Element {
    ...
    return (
        <main className="min-h-screen bg-[#f4f4f5] py-10">
            <div className="container mx-auto px-6">
                <div className="bg-white rounded-[28px] border border-[#e4e4e7] shadow-[0_20px_50px_rgba(15,23,42,0.08)] overflow-hidden">
                    <div className="p-8">
